        ...
        <div class="flex-item w-2/3 mx-auto">
            <div class="card p-6 bg-white shadow-lg rounded-lg border-gray-600">
                ...
                <div class="card-body my-4">
                    <form action="{{ route('layer.store',$layup->id) }}" method="POST">
                    @csrf
