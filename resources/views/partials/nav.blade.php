...
<nav
  ...
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    ...
    <div
      ...
      <!-- Logo -->
      <a
        class="mb-4 me-5 ms-2 mt-3 flex items-center text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 hover:text-neutral-400 focus:text-neutral-400 lg:mb-0 lg:mt-0"
        href="#">
        <img
      ...
      <ul
        ...
        <li class="mb-4 lg:mb-0 lg:pe-2" data-twe-nav-item-ref>
          <!-- Dashboard link -->
          <a
            class="@if($items[1]['label'] == 'Dashboard') active text-green-800 @else text-neutral-700 @endif transition duration-200 hover:text-neutral-700 hover:ease-in-out focus:text-neutral-700 disabled:text-black/30 motion-reduce:transition-none hover:text-neutral-300 focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 [&.active]:text-zinc-400"
            href="/dashboard"
            >Dashboard</a
          >
        </li>
        <li class="mb-4 lg:mb-0 lg:pe-2" data-twe-nav-item-ref>
          <!-- Suppliers link -->
          <a
            class="@if($items[3]['label'] == 'Supplier') active text-green-800 @else text-neutral-700 @endif transition duration-200 hover:text-neutral-700 hover:ease-in-out focus:text-neutral-700 disabled:text-black/30 motion-reduce:transition-none hover:text-neutral-300 focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 [&.active]:text-zinc-400"
            href="/supplier"
            >Supplier</a
          >
        </li>
        <li class="mb-4 lg:mb-0 lg:pe-2" data-twe-nav-item-ref>
          <!-- Layups link -->
          <a
            class="@if($items[3]['label'] == 'Layup') active text-green-800 @else text-neutral-700 @endif transition duration-200 hover:text-neutral-700 hover:ease-in-out focus:text-neutral-700 disabled:text-black/30 motion-reduce:transition-none hover:text-neutral-300 focus:text-neutral-300 lg:px-2 [&.active]:text-black/90 [&.active]:text-zinc-400"
            href="{{ $items[3]['url'] }}"
            >Layups</a
          >
        </li>
